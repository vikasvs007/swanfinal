...
app.use(cors({
  origin: ['http://localhost:3000', 'http://localhost:5173', 'http://127.0.0.1:5173', 'http://127.0.0.1:3000', 'https://swanfinal-1.onrender.com', ],
...
const apiRoutes = {
  ...
  enquiryHandling: '/api/enquiry-handling',
  notificationCenter: '/api/notification-center',
  activeUsers: '/api/active-users',
  visitorTracking: '/api/visitor-tracking',
  userStatistics: '/api/user-analytics',
  blogCategories: '/api/blog-categories',
  blogTags: '/api/blog-tags',
  userManagement: '/api/user-management',
  productCatalog: '/api/product-catalog',
